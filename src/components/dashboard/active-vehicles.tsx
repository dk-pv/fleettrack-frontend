  ...
  return (
    <div className="rounded-lg border border-border bg-card p-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">Real-time status of active fleet units</p>
      </div>
        ...
        {vehicles?.map((vehicle) => (
          ...
          >
            ...
            <div className="text-right">
              <div
                className={`inline-flex items-center gap-1.5 rounded-full px-2.5 py-0.5 text-xs font-bold tracking-wide uppercase border ${
              ...
              <p className="mt-1.5 text-sm text-foreground font-semibold">
